...
import {Box, Button, Center, Heading, Image, Link, ListItem, OrderedList, SlideFade, Text} from "@chakra-ui/react";
        ...
        <SlideFade in={true} offsetY="40px">
            ...
            <Center>
                <Box width="60rem" borderColor="white" borderWidth={2}>
                    <Heading m={5}>TERMS AND CONDITIONS</Heading>
                    <Text ml={5}>Last Updated: 2021-09-09</Text>
                    <Box m={5}>
                        <Text fontSize="lg">AGREEMENT TO TERMS</Text>
                        <Text fontSize="md">
                            These Terms of Service constitute a legally binding agreement made between you, whether
                            personally or on behalf of an entity (“you”) and CyberHunt (“we,” “us” or “our”),
                            concerning your access to and use of the CyberBucks.io website (formerly accessible through
                            cyberbucks.io address) as well as any other media form, media channel, mobile website or
                        ...
                        Service, and you waive any right to receive specific notice of each such change.
                    </Text><Text fontSize="md">
                        ...
                        accepted, the changes in any revised Terms of Service by your continued use of the Site after
                        ...
                        jurisdiction in which they reside must have the permission of their parent or guardian to use
                        the Site. If you are a minor, you must have your parent or guardian read and agree to these
                        Terms of Service prior to you using the Site.
                        ...
                        only. Except as expressly provided in these Terms of Service, no part of the Site and no Content
                        ...
                        all registration information you submit will be true, accurate, current, and complete; (2) you
                        ...
                        you are not under the age of 13 or you have received parental permission to use the Site;
                        you will not access the Site through automated or non-human means, whether through a bot,
                        script, or otherwise;
                        you will not use the Site for any illegal or unauthorized purpose;
                        you will not misuse or falsely advertise features of the Site to third parties;
                        ...
                        You are required to register an user account with the Site if you want to use full features. You
                        ...
                        User account cannot be considered as property of any kind and is only meant to guarantee you
                        access to certain areas of the Site. We reserve the right to remove your account or restrict
                        access to the account and/or the Site if we determine, in our sole discretion, that the account
                        violates Terms of Service or any applicable law or regulation.
                    </Text><Text fontSize="md">
                        One individual may register only one account on the Site. Having multiple accounts is prohibited
                        and may result in immediate ban or full deletion of such accounts.
                    </Text><Text fontSize="lg" mt={5}>
                        BALANCES AND REWARDS
                    </Text><Text fontSize="md">
                        All user balances displayed on the Site must be considered only as a game feature. These
                        balances do not have any monetary value and do not represent any real monetary equivalent.
                    </Text><Text fontSize="md">
                        All user balances displayed on the Site may not be considered as legally binding.
                    </Text><Text fontSize="md">
                        You are not entitled to any promised rewards, payments or shown balances until they are
                        delivered. We may, in our sole discretion, decide to not deliver, pay out or otherwise provide
                        you any of the rewards or cancel the rewards program any time.
                    </Text><Text fontSize="md">
                        All user rewards for playing games and other user activity are determined based on multiple
                        random factors and user actions. Different users may receive different rewards for the same
                        actions.
                    </Text><Text fontSize="md">
                        The Site does not ask for any kind of monetary or crypto deposits and does not collect any
                        payments.
                    </Text><Text fontSize="md">
                        The Site does not provide real money gambling services.
                    </Text><Text fontSize="lg" mt={5}>
                        ...
                        <OrderedList>
                            <ListItem>systematically retrieve data or other content from the Site to create or compile,
                                directly or
                                indirectly, a collection, compilation, database, or directory without written permission
                                from
                                us.</ListItem>
                            <ListItem>make any unauthorized use of the Site, including collecting usernames and/or email
                                addresses of
                                users by electronic or other means for the purpose of sending unsolicited email, or
                                creating
                                user accounts by automated means or under false pretenses.</ListItem>
                            <ListItem>use a buying agent or purchasing agent to make purchases on the Site.</ListItem>
                            <ListItem>use the Site to advertise or offer to sell goods and services.</ListItem>
                            <ListItem>circumvent, disable, or otherwise interfere with security-related features of the
                                Site,
                                including features that prevent or restrict the use or copying of any Content or enforce
                                limitations on the use of the Site and/or the Content contained therein.</ListItem>
                            <ListItem>engage in unauthorized framing of or linking to the Site.</ListItem>
                            <ListItem>trick, defraud, or mislead us and other users, especially in any attempt to learn
                                sensitive
                                account information such as user passwords;</ListItem>
                            <ListItem>make improper use of our support services or submit false reports of abuse or
                                misconduct.</ListItem>
                            <ListItem>engage in any automated use of the system, such as using scripts to send comments
                                or messages,
                                or using any data mining, robots, or similar data gathering and extraction
                                tools.</ListItem>
                            <ListItem>interfere with, disrupt, or create an undue burden on the Site or the networks or
                                services
                                connected to the Site.</ListItem>
                            <ListItem>attempt to impersonate another user or person or use the username of another
                                user.</ListItem>
                            <ListItem>sell or otherwise transfer your profile.</ListItem>
                            <ListItem>use any information obtained from the Site in order to harass, abuse, or harm
                                another person.</ListItem>
                            <ListItem>use the Site as part of any effort to compete with us or otherwise use the Site
                                and/or the
                                Content for any revenue-generating endeavor or commercial enterprise.</ListItem>
                            <ListItem>decipher, decompile, disassemble, or reverse engineer any of the software
                                comprising or in any
                                way making up a part of the Site.</ListItem>
                            <ListItem>attempt to bypass any measures of the Site designed to prevent or restrict access
                                to the Site,
                                or any portion of the Site.</ListItem>
                            <ListItem>harass, annoy, intimidate, or threaten any of our employees or agents engaged in
                                providing any
                                portion of the Site to you.</ListItem>
                            <ListItem>delete the copyright or other proprietary rights notice from any Content.
                                copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML,
                                JavaScript, or
                                other code.</ListItem>
                            <ListItem>upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses,
                                or other
                                ...
                                operation, or maintenance of the Site.</ListItem>
                            <ListItem>upload or transmit (or attempt to upload or to transmit) any material that acts as
                                a passive or
                                ...
                                “pcms”).</ListItem>
                            <ListItem>except as may be the result of standard search engine or Internet browser usage,
                                use, launch,
                                develop, or distribute any automated system, including without limitation, any spider,
                                robot,
                                cheat utility, scraper, or offline reader that accesses the Site, or using or launching
                                any
                                unauthorized script or other software.</ListItem>
                            <ListItem>disparage, tarnish, or otherwise harm, in our opinion, us and/or the
                                Site.</ListItem>
                            <ListItem>use the Site in a manner inconsistent with any applicable laws or
                                regulations.</ListItem>
                        </OrderedList>
                    </Text><Text fontSize="lg" mt={5}>
                        ...
                        <OrderedList>
                            <ListItem>the creation, distribution, transmission, public display, or performance, and the
                                accessing,
                                ...
                                moral
                                rights of any third party.</ListItem>
                            <ListItem>you are the creator and owner of or have the necessary licenses, rights, consents,
                                releases, and
                                ...
                                Service.</ListItem>
                            <ListItem>you have the written consent, release, and/or permission of each and every
                                identifiable
                                ...
                                manner
                                contemplated by the Site and these Terms of Service.</ListItem>
                            <ListItem>your Contributions are not false, inaccurate, or misleading.</ListItem>
                            <ListItem>your Contributions are not unsolicited or unauthorized advertising, promotional
                                materials,
                                pyramid schemes, chain letters, spam, mass mailings, or other forms of
                                solicitation.</ListItem>
                            <ListItem> your Contributions are not obscene, lewd, lascivious, filthy, violent, harassing,
                                libelous,
                                slanderous, or otherwise objectionable (as determined by us).</ListItem>
                            <ListItem>your Contributions do not ridicule, mock, disparage, intimidate, or abuse
                                anyone.</ListItem>
                            <ListItem>your Contributions do not advocate the violent overthrow of any government or
                                incite, encourage,
                                or threaten physical harm against another.</ListItem>
                            <ListItem>your Contributions do not violate any applicable law, regulation, or
                                rule.</ListItem>
                            <ListItem>your Contributions do not violate the privacy or publicity rights of any third
                                party.</ListItem>
                            <ListItem> your Contributions do not contain any material that solicits personal information
                                from anyone
                                under the age of 18 or exploits people under the age of 18 in a sexual or violent
                                manner.</ListItem>
                            <ListItem>your Contributions do not violate any federal or state law concerning child
                                pornography, or
                                otherwise intended to protect the health or well-being of minors;</ListItem>
                            <ListItem>your Contributions do not include any offensive comments that are connected to
                                race, national
                                origin, gender, sexual preference, or physical handicap.</ListItem>
                            <ListItem>your Contributions do not otherwise violate, or link to material that violates,
                                any provision of
                                these Terms of Service, or any applicable law or regulation.</ListItem></OrderedList>
                        <Text fontSize="md">
                        ...
                        strictly in accordance with the Terms of Service of this mobile application license contained in
                        these Terms of Service.
                    </Text><Text fontSize="md">
                        You shall not:
                    </Text><OrderedList>
                        <ListItem>decompile, reverse engineer, disassemble, attempt to derive the source code of, or
                            decrypt the
                            application;</ListItem>
                        <ListItem>make any modification, adaptation, improvement, enhancement, translation, or
                            derivative work
                            from the application;</ListItem>
                        <ListItem>violate any applicable laws, rules, or regulations in connection with your access or
                            use of the
                            application;</ListItem>
                        <ListItem>remove, alter, or obscure any proprietary notice (including any notice of copyright or
                            trademark) posted by us or the licensors of the application;</ListItem>
                        <ListItem>use the application for any revenue generating endeavor, commercial enterprise, or
                            other purpose
                            for which it is not designed or intended;</ListItem>
                        <ListItem>make the application available over a network or other environment permitting access
                            or use by
                            multiple devices or users at the same time;</ListItem>
                        <ListItem>use the application for creating a product, service, or software that is, directly or
                            indirectly, competitive with or in any way a substitute for the application;</ListItem>
                        <ListItem>use the application to send automated queries to any website or to send any
                            unsolicited
                            commercial e-mail;</ListItem>
                        <ListItem>use any proprietary information or any of our interfaces or our other intellectual
                            property in
                            the design, development, manufacture, licensing, or distribution of any applications,
                            accessories, or devices for use with the application.</ListItem>
                    </OrderedList>
                        <Text fontSize="md">
                            Apple and Android Devices
                        </Text><Text fontSize="md">
                        The following terms apply when you use a mobile application obtained from either the Apple Store
                        or Google Play (each an “App Distributor”) to access the Site:
                    </Text><OrderedList><ListItem>
                        the license granted to you for our mobile application is limited to a non-transferable license
                        ...
                        Terms of Service;</ListItem><ListItem>
                        we are responsible for providing any maintenance and support services with respect to the mobile
                        application as specified in the Terms of Service of this mobile application license contained in
                        these Terms of Service or as otherwise required under applicable law, and you acknowledge that
                        each App Distributor has no obligation whatsoever to furnish any maintenance and support
                        services with respect to the mobile application;</ListItem><ListItem>
                        in the event of any failure of the mobile application to conform to any applicable warranty, you
                        ...
                        obligation whatsoever with respect to the mobile application;</ListItem><ListItem>
                        ...
                        restricted parties;</ListItem><ListItem>
                        ...
                        wireless data service agreement when using the mobile application;</ListItem><ListItem>
                        you acknowledge and agree that the App Distributors are third-party beneficiaries of the Terms
                        of Service in this mobile application license contained in these Terms of Service, and that each
                        App Distributor will have the right (and will be deemed to have accepted the right) to enforce
                        the Terms of Service in this mobile application license contained in these Terms of Service
                        against you as a third-party beneficiary thereof.</ListItem></OrderedList>
                        ...
                        (1) providing your Third-Party Account login information through the Site; or (2) allowing us to
                        access your Third-Party Account, as is permitted under the applicable Terms of Service that
                        ...
                        any of the Terms of Service that govern your use of the applicable Third-Party Account, and
                        ...
                        Social Network Content may no longer be available on and through the Site. You will have the
                        ability to disable the connection between your account on the Site and your Third-Party Accounts
                        at any time.
                    </Text><Text fontSize="md">
                        ...
                        video, information, applications, software, commercial offers, advertisements and other content
                        ...
                        you do so at your own risk, and you should be aware these Terms of Service no longer govern.
                    </Text><Text fontSize="md">
                        ...
                        the Site, such as popup advertisements, sidebar advertisements, push notifications or banner
                        advertisements. Advertisers take full responsibility for any advertisements they place on the
                        ...
                        monitor the Site for violations of these Terms of Service;</ListItem><ListItem>
                        ...
                        or any portion thereof;</ListItem><ListItem>
                        ...
                        Terms of Service. Please be advised the Site is hosted in the United States.
                    </Text><Text fontSize="md">
                        ...
                        immediately notify us using the contact information. A copy of your Notification will be sent to
                        ...
                        SERVICE OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN
                        THE SITE OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME,
                        ...
                        any third party due to or arising out of: (1) your Contributions; (2) use of the Site; (3)
                        breach of these Terms of Service; (4) any breach of your representations and warranties set
                        forth in these Terms of Service; (5) your violation of the rights of a third party, including
                        ...
                        These Terms of Service and any policies or operating rules posted by us on the Site constitute
                        the entire agreement and understanding between you and us. Our failure to exercise or enforce
                        any right or provision of these Terms of Service shall not operate as a waiver of such right or
                        provision.
                    </Text><Text fontSize="md">
                        These Terms of Service operate to the fullest extent permissible by law. We may assign any or
                        ...
                        If any provision or part of a provision of these Terms of Service is determined to be unlawful,
                        void, or unenforceable, that provision or part of the provision is deemed severable from these
                        Terms of Service and does not affect the validity and enforceability of any remaining
                        provisions.
                    </Text><Text fontSize="md">
                        There is no joint venture, partnership, employment or agency relationship created between you
                        and us as a result of these Terms of Service or use of the Site. You agree that these Terms of
                        Service will not be construed against us by virtue of having drafted them.
                    </Text><Text fontSize="md">
                        You hereby waive any and all defenses you may have based on the electronic form of these Terms
                        ...
                        CyberHunt</Text><Text fontSize="md">
                        info@cyberbucks.io</Text>
                    </Box>
